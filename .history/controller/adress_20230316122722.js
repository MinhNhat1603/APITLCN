...
function getADistrict(data){
    ...
    console.log(t);
    fetch("https://online-gateway.ghn.vn/shiip/public-api/master-data/province",{method: 'GET', headers: {"token": "427bb6dc-bc24-11ed-9dc6-f64f768dbc22"}, params:{"province_id": 201}})
    .then((response) => response.json())
    .then((data1) => {
