...
fetch("https://online-gateway.ghn.vn/shiip/public-api/master-data/district",{method: 'GET', body: JSON.stringify({province_id: 202}), 
    headers: {"token": "427bb6dc-bc24-11ed-9dc6-f64f768dbc22", "Content-Type"}})
...
function getADistrict(data){
    ...
    console.log(t);
    fetch("https://online-gateway.ghn.vn/shiip/public-api/master-data/district",{method: 'GET', headers: {"token": "427bb6dc-bc24-11ed-9dc6-f64f768dbc22"}, body: JSON.stringify({"province_id": 202})})
    .then((response) => response.json())
    .then((data1) => {
        console.log(data1); // data là một object
    }); 
}