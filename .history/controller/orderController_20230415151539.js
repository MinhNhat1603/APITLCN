    ...
    addOrder: async(req,res)=>{
        try {
            ...
            for(let i=0; i < cart.length; i++){
                ...
                var results = await fetch("http://localhost:3000/product/"+ cart[i].productId, {method: 'PUT', headers: {"Content-Type": "application/json"},body: JSON.stringify({"inventory": 11, "sold": 22})}) 
                if(inventory!= null){
