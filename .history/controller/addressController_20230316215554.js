const addressController ={
    code: async(req,res)=>{
        try {
            ...
            //     shippingFee[i]= await fetch("https://online-gateway.ghn.vn/shiip/public-api/v2/shipping-order/fee",
            ...
            //     {method: 'POST', body: JSON.stringify({"service_id":service[1].service_id, "insurance_value":500000, "coupon": null, "from_district_id":1542, 
            //     "to_district_id":code[1], "to_ward_code":code[2],  "height":2, "length":30, "weight":200*1, "width":20}), 
            //     headers: {"token": "427bb6dc-bc24-11ed-9dc6-f64f768dbc22", "Content-Type": "application/json", "shop_id": 3912285}})
            var shippingFee= await fetch("https://online-gateway.ghn.vn/shiip/public-api/v2/shipping-order/fee",
                ...
                "width":15}), 
                headers: {"token": "427bb6dc-bc24-11ed-9dc6-f64f768dbc22", "shop_id": 3912285, "Content-Type": "application/json"}})const dataService = await Service.json();    
