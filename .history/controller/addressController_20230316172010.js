const addressController ={
    code: async(req,res)=>{
        try {
            ...
            const Ward = await fetch("https://online-gateway.ghn.vn/shiip/public-api/master-data/ward",{method: 'POST', body: JSON.stringify({"province_id": code[1]}),headers: {"token": "427bb6dc-bc24-11ed-9dc6-f64f768dbc22", "Content-Type": "application/json"}})
            const dataWard = await Ward.json()
            code[1]=getWard(dataDistrict,address,t)
