const addressController ={
    code: async(req,res)=>{
        try {
            ...
            const Ward = await fetch("https://online-gateway.ghn.vn/shiip/public-api/master-data/district",{method: 'POST', body: JSON.stringify({"province_id": code[0]}),headers: {"token": "427bb6dc-bc24-11ed-9dc6-f64f768dbc22", "Content-Type": "application/json"}})
            const dataWard = await District.json()
            code[1]=getDistrict(dataDistrict,address,t)
