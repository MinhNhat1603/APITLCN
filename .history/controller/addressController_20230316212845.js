    ...
    code: async(req,res)=>{
        try {
            ...
            for ( let i = 0; i< service.length; i++){
                ...
                {method: 'POST', body: JSON.stringify({"service_id":100039, "insurance_value":500000, "coupon": null, "from_district_id":1542, "to_district_id":1542, "to_ward_code":"20314",  "height":15, "length":15, "weight":1000, "width":15}), 
                headers: {"token": "427bb6dc-bc24-11ed-9dc6-f64f768dbc22", "Content-Type": "application/json"}})
            }
