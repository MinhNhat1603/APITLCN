...
const orderController = {
    ...
    addOrder: async(req,res)=>{
        try {
            ...
            //     }            
            // }
            var product = await fetch("http://localhost:3000/product/638080c4c20e8937f190efd6", {method: 'GET', headers: {"token": "427bb6dc-bc24-11ed-9dc6-f64f768dbc22", "Content-Type": "application/json"}} )
            res.status(200).json(product);
        } catch (error) {
