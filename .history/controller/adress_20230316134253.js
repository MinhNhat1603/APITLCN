...
const Address ="01 Võ Văn Ngân, Bình Thọ, TP. Thủ Đức, Thành phố Hồ Chí Minh, Vietnam";
...
function getDistrict(data){
    ...
    console.log(t);
    fetch("https://online-gateway.ghn.vn/shiip/public-api/master-data/ward",{method: 'POST', body: JSON.stringify({"province_id": codeProvince}), 
    headers: {"token": "427bb6dc-bc24-11ed-9dc6-f64f768dbc22", "Content-Type": "application/json"}})
    .then((response) => response.json())
    .then((data1) => {
