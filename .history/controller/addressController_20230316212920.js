    ...
    code: async(req,res)=>{
        try {
            ...
            for ( let i = 0; i< service.length; i++){
                ...
                {method: 'POST', body: JSON.stringify({"service_id":service[i].s, "insurance_value":500000, "coupon": null, "from_district_id":1542, 
                "to_district_id":1542, "to_ward_code":"20314",  "height":15, "length":15, "weight":1000, "width":15}), 
                headers: {"token": "427bb6dc-bc24-11ed-9dc6-f64f768dbc22", "Content-Type": "application/json"}})
            }
            const shippingFee= await fetch("https://online-gateway.ghn.vn/shiip/public-api/v2/shipping-order/fee",
            {method: 'POST', body: JSON.stringify({"shop_id": 3912285, "from_district": 1542 , "to_district": 1542}), 
            headers: {"token": "427bb6dc-bc24-11ed-9dc6-f64f768dbc22", "Content-Type": "application/json"}})
            res.status(200).json(service.length);
        } catch (error) {
